      ...
      <section className="content-panel" style={{ marginBottom: "1rem" }}>
        <div style={{ display: "flex", justifyContent: "space-between", gap: "1rem", alignItems: "baseline", flexWrap: "wrap" }}>
          <div>
            ...
            <p style={{ marginBottom: 0 }}>Eski bir yayını doğrudan canlıya basmak yerine güvenli biçimde taslağa geri al.</p>
          </div>
          <Link href="/icerik/gecmis">Genel Sürüm Geçmişi ↗</Link>
        </div>
        {revisions.length === 0 ? (

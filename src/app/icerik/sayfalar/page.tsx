    ...
    <section className="content-editor-page">
      <div className="content-page-heading">
        ...
        <div className="content-profile">
          <strong>{published} yayında</strong>
          <small>{drafts} taslak · {archived} arşiv</small>
        </div>
      </div>
      ...
      <div className="content-panel">
        {pages.length === 0 ? (
          <div className="content-empty-state">
            ...
            <p>İlk sayfayı oluşturduğunuzda burada görünecek. Yasal ve Rehber kayıtları kendi modüllerinde yönetilir.</p>

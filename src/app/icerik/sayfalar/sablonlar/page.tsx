...
export default async function CmsPageTemplatesPage({
  ...
  const [access, query] = await Promise.all([
    requireCmsManager("/icerik/sayfalar/sablonlar"),
    searchParams,
  ]);
    ...
    <section className="content-editor-page" style={{ maxWidth: "none" }}>
      <div className="content-page-heading">
        <div>
          ...
          <p>
            Hazır şablondan başlayın; Hero, metin, görsel, kart, CTA, adımlar,
            istatistik, SSS, galeri ve diğer İlkOku bloklarını ekleyip sıralayın.
          </p>
        </div>
        <aside
          className="cms-editor-status-card"
          data-tone="success"
          aria-label="Görsel oluşturucu durumu"
        >
          ...
          <div className="cms-editor-status-card__meta">
            <span className="cms-editor-chip is-positive">Canlı önizleme</span>
            <span className="cms-editor-chip is-positive">Drag / drop</span>
            <span className="cms-editor-chip">13 blok</span>
          </div>
        </aside>
      </div>
      ...
      <nav className="cms-editor-toolbar" aria-label="Görsel sayfa oluşturucu hızlı işlemleri">
        <div className="cms-editor-toolbar__cluster">
          ...
          <Link href="/icerik/sayfalar/yeni">Klasik metin sayfası</Link>
        </div>
        <div className="cms-editor-toolbar__cluster">
      ...
      {query.hata === "blok" ? (
        <div className="content-panel cms-editor-notice is-danger" role="alert">
          <strong>Görsel sayfa taslağı kaydedilemedi.</strong>
          <p>
            Geçersiz blok, bağlantı veya Medya kütüphanesinde yayınlanmamış bir görsel
            bulundu. Sayfa oluşturulmadı; alanları kontrol edip yeniden kaydedin.
          </p>
        </div>
      ) : null}
      ...
      <div className="content-panel cms-editor-notice is-info">
        ...
        <p>
          Sayfanın orta alanını bloklarla kurarsınız. Global header/footer, renk sistemi,
          tipografi, responsive davranış ve güvenli yayın zinciri ortak site sisteminden
          gelir; böylece yeni sayfa başka bir site gibi görünmez.
        </p>
      </div>

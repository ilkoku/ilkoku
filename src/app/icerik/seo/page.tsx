  ...
  return (
    <section className="content-editor-page">
      <div className="content-page-heading">
        <div><span>Büyüme · SEO</span><h1>SEO Merkezi</h1><p>Yayındaki Türkçe sayfa metadata sorunlarını ve Ana Sayfa on-page SEO sinyallerini tek çalışma masasında yönetin; teşhisten canonical içerik editörüne doğrudan gidin.</p></div>
        ...
        <div className={ops.layout}>
          ...
          <aside className={ops.sidePane}>
            ...
            <div className={ops.sideBody}>
              ...
              <div className={ops.actionRow}><Link href="/icerik/rol-kartlari?dil=tr">Rol Kartları</Link><Link href="/icerik/yonlendirmeler">Yönlendirmeler</Link><Link href="/icerik/saglik">Sistem Sağlığı</Link></div>
            </div>
          </aside>
        </div>
      </div>

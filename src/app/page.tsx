...
const benefits = [
  {
    icon: "book",
    title: "Eserlerini Tek Yerde Yönet",
    description: "Eserlerini oluştur, düzenle ve arşivle.",
  },
  {
    icon: "writer",
    title: "Yazmaya Devam Et",
    description: "Bölümlerini yaz ve taslaklarını kaydet.",
  },
  {
    icon: "message",
    title: "Editörlerle İletişim Kur",
    description: "Eserin için editör değerlendirmesi talep et.",
  },
  {
    icon: "publisher",
    title: "Yayınevlerine Başvur",
    description: "Eserini yayınevlerinin incelemesine sun.",
  },
  {
    icon: "feedback",
    title: "Geri Bildirimlerini Takip Et",
    description: "Eserlerine gelen geri bildirimleri görüntüle.",
  },
] as const;
    ...
    <main className="landing-page">
      ...
      <section className="landing-hero" id="hakkimizda">
        <div className="landing-container landing-hero__grid">
          <div className="landing-hero__content">
            ...
            <p>
              Yazarları, editörleri, okuyucuları ve yayınevlerini aynı
              platformda buluşturan dijital edebiyat ekosistemi.
            </p>
          ...
          <div className="landing-role-grid">
            {roles.map((role) => (
              ...
              >
                ...
                <span
                  className="landing-role__icon"
                  aria-hidden="true"
                >
                  <LandingIcon name={role.icon} />
                </span>
        ...
        <div className="landing-container">
          ...
          <div className="landing-steps">
            ...
            <article>
              ...
              <p>
                Eserlerini paylaş, geri bildirim al veya yeni eserler
                keşfet.
              </p>
            </article>
          </div>
        ...
        <div className="landing-container">
          <div className="landing-cta__inner">
            <div>
              ...
              <p>
                Rolünü seç, hesabını oluştur ve İlkOku topluluğuna
                katıl.
              </p>
            </div>
      ...
      >
        <div className="landing-container landing-footer__grid">
          ...
          <div>
            <h3>Destek</h3>
            <a href="mailto:destek@ilkoku.com">
              Yardım Merkezi
            </a>
          </div>
        </div>

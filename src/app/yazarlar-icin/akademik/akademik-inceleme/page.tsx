...
const definition = getEducationGuideDefinition("akademik-inceleme");
export const metadata: Metadata = { title: `${definition.title} | İlkOku`, description: definition.description, alternates: { canonical: "https://ilkoku.com/yazarlar-icin/akademik/akademik-inceleme" }, robots: { index: true, follow: true } };

...
const definition = getEducationGuideDefinition("cizgi-roman");
export const metadata: Metadata = { title: `${definition.title} | İlkOku`, description: definition.description, alternates: { canonical: "https://ilkoku.com/yazarlar-icin/cizgi-anlati/cizgi-roman" }, robots: { index: true, follow: true } };

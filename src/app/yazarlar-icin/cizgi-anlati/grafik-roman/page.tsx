...
const definition = getEducationGuideDefinition("grafik-roman");
export const metadata: Metadata = { title: `${definition.title} | İlkOku`, description: definition.description, alternates: { canonical: "https://ilkoku.com/yazarlar-icin/cizgi-anlati/grafik-roman" }, robots: { index: true, follow: true } };

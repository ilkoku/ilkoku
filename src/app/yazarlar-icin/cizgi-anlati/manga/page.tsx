...
const definition = getEducationGuideDefinition("manga");
export const metadata: Metadata = { title: `${definition.title} | İlkOku`, description: definition.description, alternates: { canonical: "https://ilkoku.com/yazarlar-icin/cizgi-anlati/manga" }, robots: { index: true, follow: true } };

...
export const metadata: Metadata = { title: `${definition.title} | İlkOku`, description: definition.description, alternates: { canonical: "https://ilkoku.com/yazarlar-icin/cocuk-ve-genclik/egitici-cocuk-kitabi" }, robots: { index: true, follow: true } };

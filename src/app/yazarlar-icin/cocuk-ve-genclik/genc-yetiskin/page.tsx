...
const definition = getEducationGuideDefinition("genc-yetiskin");
export const metadata: Metadata = { title: `${definition.title} | İlkOku`, description: definition.description, alternates: { canonical: "https://ilkoku.com/yazarlar-icin/cocuk-ve-genclik/genc-yetiskin" }, robots: { index: true, follow: true } };

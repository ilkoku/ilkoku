...
const definition = getEducationGuideDefinition("biyografi");
...
export default async function BiyografiPage() { return <BatchedEducationGuidePage definition={definition} />; }

...
const definition = getEducationGuideDefinition("elestiri");
...
export default async function ElestiriPage() { return <BatchedEducationGuidePage definition={definition} />; }

...
const definition = getEducationGuideDefinition("gezi-yazisi");
...
export default async function GeziYazisiPage() { return <BatchedEducationGuidePage definition={definition} />; }

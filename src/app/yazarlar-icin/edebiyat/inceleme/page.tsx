...
const definition = getEducationGuideDefinition("inceleme");
...
export default async function IncelemePage() { return <BatchedEducationGuidePage definition={definition} />; }

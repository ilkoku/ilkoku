...
const definition = getEducationGuideDefinition("otobiyografi");
...
export default async function OtobiyografiPage() { return <BatchedEducationGuidePage definition={definition} />; }

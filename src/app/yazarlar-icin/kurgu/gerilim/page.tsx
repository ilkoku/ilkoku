...
const definition = getFictionGuideDefinition("gerilim");
export const metadata: Metadata = { title: `${definition.title} | İlkOku`, description: definition.description, alternates: { canonical: "https://ilkoku.com/yazarlar-icin/kurgu/gerilim" }, robots: { index: true, follow: true } };

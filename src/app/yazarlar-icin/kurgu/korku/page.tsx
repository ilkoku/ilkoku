...
const definition = getFictionGuideDefinition("korku");
export const metadata: Metadata = { title: `${definition.title} | İlkOku`, description: definition.description, alternates: { canonical: "https://ilkoku.com/yazarlar-icin/kurgu/korku" }, robots: { index: true, follow: true } };

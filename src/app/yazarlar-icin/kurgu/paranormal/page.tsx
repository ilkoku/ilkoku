...
const definition = getFictionGuideDefinition("paranormal");
export const metadata: Metadata = { title: `${definition.title} | İlkOku`, description: definition.description, alternates: { canonical: "https://ilkoku.com/yazarlar-icin/kurgu/paranormal" }, robots: { index: true, follow: true } };

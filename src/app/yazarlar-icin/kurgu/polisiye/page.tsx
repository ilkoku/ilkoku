...
const definition = getFictionGuideDefinition("polisiye");
export const metadata: Metadata = { title: `${definition.title} | İlkOku`, description: definition.description, alternates: { canonical: "https://ilkoku.com/yazarlar-icin/kurgu/polisiye" }, robots: { index: true, follow: true } };

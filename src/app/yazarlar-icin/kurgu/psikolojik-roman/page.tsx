...
const definition = getFictionGuideDefinition("psikolojik-roman");
export const metadata: Metadata = { title: `${definition.title} | İlkOku`, description: definition.description, alternates: { canonical: "https://ilkoku.com/yazarlar-icin/kurgu/psikolojik-roman" }, robots: { index: true, follow: true } };

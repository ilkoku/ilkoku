...
const definition = getFictionGuideDefinition("tarihi-roman");
export const metadata: Metadata = { title: `${definition.title} | İlkOku`, description: definition.description, alternates: { canonical: "https://ilkoku.com/yazarlar-icin/kurgu/tarihi-roman" }, robots: { index: true, follow: true } };

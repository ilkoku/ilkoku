...
const definition = getFictionGuideDefinition("utopya");
export const metadata: Metadata = { title: `${definition.title} | İlkOku`, description: definition.description, alternates: { canonical: "https://ilkoku.com/yazarlar-icin/kurgu/utopya" }, robots: { index: true, follow: true } };

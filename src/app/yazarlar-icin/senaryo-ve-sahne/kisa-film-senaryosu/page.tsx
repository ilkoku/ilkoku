...
const definition = getEducationGuideDefinition("kisa-film-senaryosu");
export const metadata: Metadata = { title: `${definition.title} | İlkOku`, description: definition.description, alternates: { canonical: "https://ilkoku.com/yazarlar-icin/senaryo-ve-sahne/kisa-film-senaryosu" }, robots: { index: true, follow: true } };

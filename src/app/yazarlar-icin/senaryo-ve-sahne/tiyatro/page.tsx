...
export const metadata: Metadata = { title: `${definition.title} | İlkOku`, description: definition.description, alternates: { canonical: "https://ilkoku.com/yazarlar-icin/senaryo-ve-sahne/tiyatro" }, robots: { index: true, follow: true } };

    ...
    <main className="how-page community-rules-page">
      ...
      <section className="community-integrity how-container" id="platform-butunlugu">
        ...
        <div className="community-integrity__grid">
          ...
          {sectionMap.get("Eser, telif ve intihal sınırı") ? <article><span>02</span><CommunityIcon name="shield" /><h3>Eser ve telif</h3><EditorialBody body={sectionMap.get("Eser, telif ve intihal sınırı")!.body} /><Link href="/yasal/telif-hakki-politikasi">Telif Hakkı Politikası →</Link></article> : null}

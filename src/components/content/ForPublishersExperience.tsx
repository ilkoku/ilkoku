  ...
  return (
    <main className="how-page for-publishers-page">
        ...
        <div className="how-container how-hero__grid">
          <div className="how-hero__content">
            ...
            <div className="how-hero__actions">
              <Link className="how-button how-button--primary" href="/kayit?rol=publisher">Yayınevi olarak başla <span aria-hidden="true">→</span></Link>
              <Link className="how-button how-button--secondary" href="#yayinevi-kesfi">Keşif akışını gör</Link>
            </div>
      ...
      <nav className="how-quick-nav how-container" aria-label="Sayfa bölümleri">
        <a href="#yayinevi-kesfi"><span>01</span>Keşif</a>
        <a href="#kurumsal-degerlendirme"><span>02</span>Değerlendirme</a>
        <a href="#yetki-sinirlari"><span>03</span>Yetkiler</a>
        <a href="#ticari-surec"><span>04</span>Sözleşme</a>
      </nav>
      ...
      <section className="publishers-evaluation" id="kurumsal-degerlendirme">
        <div className="how-container">
          <SectionHeading eyebrow="Ekip içi değerlendirme" title="İlgiyi ekip içinde taşı; erişimi genelleştirme." description="Paylaşım, pasaport ve editör talebi birbirinden ayrı kurumsal araçlardır." />
          <div className="publishers-evaluation__grid">
      ...
      <section className="publishers-permissions how-container" id="yetki-sinirlari">
        <SectionHeading eyebrow="Rol ve izin modeli" title="En geniş erişim varsayılan değildir." description="Keşif yapan, paylaşım yapan, içerik gören ve sözleşme yöneten kullanıcı aynı kişi olmak zorunda değildir." />
        <div className="publishers-permissions__grid">
          {sectionMap.get("Ekip üyelerini rol ve yetki sınırlarıyla yönet") ? <article className="publishers-permissions__primary"><PublisherIcon name="team" /><span>Ekip ve yetkiler</span><h3>Her üyeye yalnız görevini gerektiren erişimi ver.</h3><EditorialBody body={sectionMap.get("Ekip üyelerini rol ve yetki sınırlarıyla yönet")!.body} /></article> : null}
      ...
      <section className="publishers-contract" id="ticari-surec">
        <div className="how-container">
          <SectionHeading eyebrow="Ticari karar sınırı" title="Keşif, değerlendirme ve sözleşmeyi ayrı yaşam döngülerinde tut." description="İlgi sinyalleri ancak tarafların ayrıca verdiği kararlarla ticari sürece dönüşür." />
          <div className="publishers-contract__grid">
            ...
            {sectionMap.get("İlkOku yayınevi için neyi garanti etmez") ? <article><PublisherIcon name="shield" /><span>Gerçekçi beklenti</span><h3>Keşif imkânı vardır; ticari sonuç garantisi yoktur.</h3><EditorialBody body={sectionMap.get("İlkOku yayınevi için neyi garanti etmez")!.body} /></article> : null}
          </div>
        </div>
      </section>

      {sectionMap.get("Yayınevi olarak başla") ? <section className="publishers-start how-container"><PublisherIcon name="building" /><div><span>Kurumsal başlangıç</span><h2>Önce üyeliği kur; sonra ekibin yetki sınırlarını belirle.</h2><EditorialBody body={sectionMap.get("Yayınevi olarak başla")!.body} /><div className="publishers-start__actions"><Link className="how-button how-button--primary" href="/kayit?rol=publisher">Yayınevi başvurusu <span aria-hidden="true">→</span></Link><Link className="how-button how-button--secondary" href="/giris">Mevcut hesapla giriş</Link></div></div></section> : null}

      {extras.length ? <section className="how-container how-extra"><SectionHeading eyebrow="Ek bilgiler" title="Yayınevi çalışma alanı hakkında diğer notlar" />{extras.map((section) => <article key={section.title}><h3>{section.title}</h3><EditorialBody body={section.body} /></article>)}</section> : null}
    </main>
  );
}

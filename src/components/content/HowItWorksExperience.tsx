...
export function HowItWorksExperience({ body, summary, title, updatedAt }: HowItWorksExperienceProps) {
  ...
  return (
    <main className="how-page">
      ...
      <aside className="how-related how-container" aria-label="İlkOku içinde devam et"><SectionHeading eyebrow="İlkOku içinde devam et" title="Platformu kendi yolundan keşfet." /><div className="how-related__grid"><Link href="/eserler"><strong>Eserleri keşfet</strong><span>Herkese açık yayımlanmış eserleri incele.</span></Link><Link href="/yazarlar"><strong>Yazarları keşfet</strong><span>Public yazar vitrinlerinden eserlere ulaş.</span></Link><Link href="/editorler"><strong>Editörleri incele</strong><span>Public görünürlüğe açık editör profillerini gör.</span></Link><Link href="/yardim"><strong>Yardım Merkezi</strong><span>Hesap ve kullanım sorularına yanıt bul.</span></Link></div></aside>

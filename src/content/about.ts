...
Aynı eser, her rol için farklı bir anlam taşır. İlkOku bu rolleri birbirine karıştırmadan aynı yolculukta buluşturur.

### Yazar

Yazar eserin sahibi ve yolculuğun başlangıç noktasıdır. Eserini oluşturur, bölümlerini geliştirir, yayımlar, okur geri bildirimlerini takip eder ve ihtiyaç duyduğunda profesyonel editör incelemesi talep eder. Platformdaki süreç, yazarın yaratıcı kararının yerine geçmez; onu daha görünür ve yönetilebilir hale getirir.
...
Editörün görevi eseri kendi zevkine göre yeniden yazmak değil; metni bağımsız ve profesyonel bir bakışla değerlendirmektir. İlkOku'daki iki aşamalı editör süreci, değerlendirmeyi tek bir görüşe bağlı bırakmadan yazara daha düzenli bir profesyonel geri bildirim sunmayı amaçlar.
...
Bir metnin son dosyası önemlidir; fakat o dosyaya nasıl ulaşıldığı da değerlidir. Yazım oturumları, revizyonlar, sürümler ve profesyonel inceleme durumu; eserin İlkOku içindeki gelişim hikâyesini oluşturur.

Eser Pasaportu bu yaklaşımın merkezindedir. Amacı bir esere yapay bir başarı puanı vermek değil; platform üzerinde oluşan süreci anlaşılır bir kayıt yapısında bir araya getirmektir. Böylece eser yalnızca “ne oldu?” sorusuyla değil, “nasıl gelişti?” sorusuyla da görülebilir.
...
Çünkü her büyük hikâye bir ilk cümleyle başlar. O ilk cümlenin doğru okura, doğru değerlendirmeye ve doğru fırsata ulaşabilmesi için İlkOku var.`,
} as const;

...
export type SystemOperationsPanelView =
  | "all"
  | "summary"
  | "gaps"
  | "workflows"
...
export function SystemOperationsPanel({
  ...
  report: SystemOperationsReport;
  view?: SystemOperationsPanelView;
}) {
  const overallStatus: OperationStatus = report.summary.blockers > 0
    ...
    : report.summary.warnings > 0 || report.scanMode === "limited"
      ? "warn"
      : "pass";
  const show = (section: Exclude<SystemOperationsPanelView, "all" | "summary">) => view === "all" || view === section;
  ...
  return (
    <div className="system-ops-root">
      ...
      {show("actions") ? (
        <section className="system-ops-pane system-ops-pane--standalone" aria-labelledby="system-ops-actions-title">
          <div className="system-map-section-heading">
            <div><p>SERVER ACTION</p><h2 id="system-ops-actions-title">Action modülleri</h2></div>
      ...
      {show("data") ? (
        <section className="system-ops-pane system-ops-pane--standalone" aria-labelledby="system-ops-data-title">
          <div className="system-map-section-heading">
            <div><p>VERİ KATMANI</p><h2 id="system-ops-data-title">Prisma / raw SQL izleri</h2></div>

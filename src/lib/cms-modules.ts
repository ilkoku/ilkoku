...
export const cmsModules: CmsModule[] = [
  ...
  { href: "/icerik/sayfalar", label: "Sayfalar", description: "Kurumsal ve bilgilendirme sayfaları", group: "Site", enabled: true, mode: "controlled-write" },
  ...
  { href: "/icerik/rehber", label: "Rehber & İçerikler", description: "Editoryal kurumsal içerikler", group: "İçerik", enabled: true, mode: "controlled-write" },

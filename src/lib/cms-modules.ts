...
export const cmsModules: CmsModule[] = [
  ...
  { href: "/icerik/site-kimligi", label: "Site Kimliği", description: "Logo, header kimliği, public sayfa etiketi ve footer sloganı", group: "Site", enabled: true, mode: "admin-control", adminOnly: true },
  ...
  { href: "/icerik/sayfalar/sablonlar", label: "Sayfa Şablonları", description: "Hazır İlkOku iskeletlerinden kodsuz yeni public sayfa başlatma", group: "Site", enabled: true, mode: "controlled-write" },
  ...
  { href: "/icerik/egitim", label: "Eğitim", description: "7 ana kategori ve 83 eser türünün eğitim sayfaları ve 7 görsel slotu", group: "İçerik", enabled: true, mode: "controlled-write" },

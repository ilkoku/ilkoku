...
export const cmsModules: CmsModule[] = [
  ...
  { href: "/icerik/okur-egitim", label: "Okur Eğitim Merkezi", description: "Okurluk Okulu eğitim sayfaları ve 6 görsel slotu", group: "Medya & Eğitim", enabled: true, mode: "controlled-write" },
  ...
  { href: "/icerik/banner-reklam-alanlari", label: "Banner / Reklam Alanları", description: "Onaylı reklam alanlarını aktif veya pasif yönet", group: "Yayın & Görünürlük", enabled: true, mode: "admin-control", adminOnly: true },
